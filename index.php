          ...
          <?php foreach($json_data['education'] AS $education) { ?>
              <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div class="flex-shrink-0">
                  <span class="text-primary"><?php echo $education['years']; ?></span>
                </div>
              </div>
          <?php  } ?>
        </div>
          ...
          <?php foreach($json_data['skills'] AS $skills) { ?>
              <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div class="flex-grow-1">
                  ...
                  <div class="subheading mb-3"><?php echo $skills['sub']; ?></div>
                  <p><?php echo $skills['desc']; ?></p>
                </div>
                <div class="flex-shrink-0">
                  <span class="text-primary"><?php echo $skills['level']; ?></span>
                </div>
              </div>
          <?php  } ?>
        </div>
          ...
          <?php foreach($json_data['interests'] AS $interests) { ?>
              <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div class="flex-grow-1">
                  ...
                  <div class="subheading mb-3"><?php echo $interests['sub']; ?></div>
                  <p><?php echo $interests['desc']; ?></p>
                </div>
                <div class="flex-shrink-0">
                  <span class="text-primary"><?php echo $interests['level']; ?></span>
                </div>
              </div>
          <?php  } ?>
        </div>
